...
<div class="bg-base-200 box-border px-2 max-lg:w-full lg:w-[75dvw] min-h-max overflow-hidden z-50">
  <div class="grid lg:py-5 box-border max-lg:grid-cols-1 lg:grid-cols-2 items-center overflow-hidden justify-evenly">
    ...
    <div class="flex overflow-hidden items-center max-lg:w-[100dvw] lg:place-self-end z-50">
      <ChatDropdown
